...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  return (
    <div className="space-y-6 text-left max-w-7xl mx-auto">
      ...
      <div className="card-elevated p-6 sm:p-8 border-l-4 border-l-indigo-500 flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-xl">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span className="badge badge-indigo">AI Academic Radar</span>
            <span className="text-xs font-mono text-slate-400">
              Target: Sem {student.semester} Mastery
            </span>
          </div>
          ...
          <p className="text-sm text-slate-300 mt-1">
            ...
            <span className="text-white font-medium">{student.course} ({student.branch})</span>.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="btn-pill-primary text-sm py-2.5 px-5 cursor-pointer"
          >
          ...
          <button
            ...
            disabled={isScraping}
            className="btn-outline text-sm py-2.5 px-4 cursor-pointer"
          >
            <span
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="w-12 h-12 rounded-xl bg-indigo-950/60 border border-indigo-500/30 flex items-center justify-center text-indigo-400 group-hover:scale-105 transition-transform shadow-md">
        ...
        >
          <div>
            <span className="form-label text-[11px] mb-1">Question Bank (PYQs)</span>
            <div className="text-2xl font-bold font-mono text-white">
              {totalPYQs > 0 ? totalPYQs : '85'} questions
            </div>
            <span className="text-xs text-cyan-400 flex items-center gap-1 mt-1 font-mono">
              <span className="material-symbols-outlined text-[14px]">history_edu</span>
              Multi-Year Papers
            </span>
          </div>
          <div className="w-12 h-12 rounded-xl bg-cyan-950/60 border border-cyan-500/30 flex items-center justify-center text-cyan-400 group-hover:scale-105 transition-transform shadow-md">
        ...
        <div
          ...
          className="card-base p-5 flex items-center justify-between cursor-pointer group hover:border-amber-500/40"
        >
          <div>
          ...
          <div className="w-12 h-12 rounded-xl bg-amber-950/60 border border-amber-500/30 flex items-center justify-center text-amber-400 group-hover:scale-105 transition-transform shadow-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-4">
          <div className="card-base p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {/* Tier 1 Preview Card */}
              <div className="card-tier1 p-5 text-left">
                <div className="flex items-center justify-between mb-2">
                  <span className="badge badge-emerald">Tier 1</span>
                  <span className="text-[11px] font-mono text-emerald-400 font-bold">Score &ge; 65</span>
                </div>
              ...
              {/* Tier 2 Preview Card */}
              <div className="card-tier2 p-5 text-left">
                <div className="flex items-center justify-between mb-2">
                  <span className="badge badge-amber">Tier 2</span>
                  <span className="text-[11px] font-mono text-amber-400 font-bold">Score 35–64</span>
                </div>
              ...
              {/* Tier 3 Preview Card */}
              <div className="card-tier3 p-5 text-left">
                <div className="flex items-center justify-between mb-2">
                  <span className="badge badge-slate">Tier 3</span>
                  <span className="text-[11px] font-mono text-slate-400 font-bold">Score &lt; 35</span>
                </div>
        ...
        <div className="lg:col-span-4 space-y-4">
          <div className="card-base p-6">
            ...
            {notices.length === 0 ? (
              ...
              <div className="space-y-3 max-h-[360px] overflow-y-auto pr-1">
                {notices.slice(0, 4).map((notice) => (
                  <div
                    key={notice.id}
                    className="p-3.5 rounded-xl bg-[#090c14] border border-slate-800 hover:border-slate-700 transition-colors text-left"
                  >
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      {notice.target_semesters && notice.target_semesters.length > 0 && (
                        <span className="text-[9px] font-mono px-2 py-0.5 rounded-full bg-amber-950/70 text-amber-300 border border-amber-600/30">
            ...
            <button
              onClick={() => onNavigateTab('notices')}
              className="w-full mt-4 pt-3 text-center text-xs text-indigo-400 hover:text-indigo-300 font-semibold block border-t border-slate-800 cursor-pointer"
            >
              View All Notices &amp; Delivery Log ➔
            </button>
          </div>
        </div>
      </div>
