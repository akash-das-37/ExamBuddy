"""Initial schema — all tables for ExamBuddy (compatible with SQLite and PostgreSQL)
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("target_courses", sa.JSON(), nullable=True),
        sa.Column("target_semesters", sa.JSON(), nullable=True),
    )
